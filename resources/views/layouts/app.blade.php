                            ...
                            <g fill="none" fill-rule="evenodd">
                                <g class="fill-current">
                                    ...
                                    <text font-family="Helvetica" font-size="12" transform="translate(51 14)">
                                        <tspan x="120.117" y="14"> feathery remainders</tspan>
                                    </text>
                                </g>
                                <path class="stroke-current" stroke-opacity=".218" stroke-width=".5"
                    ...
                    <div class="flex items-center ml-auto">
                        ...
                        @else
                            ...
                            <dropdown align="right" width="">
                                ...
                                {{--<a href="#" class="dropdown-menu-link hover:bg-gray-300" onclick="javascript: document.querySelector('#logout-form').submit()">Logout</a>--}}
                                <form id="logout-form" action="/logout" method="POST">
                                    @csrf
                                    <button type="submit" class="dropdown-menu-link w-full text-left hover:bg-gray-300">Logout</button>
                                </form>
                            </dropdown>
                        @endguest
                    </div>
