        ...
        <form @submit.prevent="submit">
            <div class="flex">
                ...
                <div class="flex-1 ml-4">
                    <div class="mb-4">
                        ...
                        <input type="text" class="border border-muted p-2 text-xs block w-full rounded mb-2 bg-transparent"
                               placeholder="Task 1"
                    ...
                    <button type="button" class=" inline-flex items-center text-xs" @click.prevent="addTask">
            ...
            <footer class="flex justify-end">
                <button type="button" class="button is-outlined mr-2"
                        @click="$modal.hide('new-project')">Cancel
                </button>
